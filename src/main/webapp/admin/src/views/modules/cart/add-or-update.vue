    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='kafei' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品库存" prop="kafeiKucunNumber">
                        <el-input v-model="kafeiForm.kafeiKucunNumber"
                                  placeholder="商品库存" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品库存" prop="kafeiKucunNumber">
                            <el-input v-model="ruleForm.kafeiKucunNumber"
                                      placeholder="商品库存" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='kafei' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="kafeiOldMoney">
                        <el-input v-model="kafeiForm.kafeiOldMoney"
                                  placeholder="商品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品原价" prop="kafeiOldMoney">
                            <el-input v-model="ruleForm.kafeiOldMoney"
                                      placeholder="商品原价" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='kafei' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="kafeiClicknum">
                        <el-input v-model="kafeiForm.kafeiClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="kafeiClicknum">
                            <el-input v-model="ruleForm.kafeiClicknum"
