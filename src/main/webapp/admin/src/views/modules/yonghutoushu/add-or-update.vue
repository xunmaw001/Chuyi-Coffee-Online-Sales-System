    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="投诉标题" prop="yonghutoushuName">
                       <el-input v-model="ruleForm.yonghutoushuName"
                                 placeholder="投诉标题" clearable  :readonly="ro.yonghutoushuName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="投诉标题" prop="yonghutoushuName">
                           <el-input v-model="ruleForm.yonghutoushuName"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yonghutoushuPhoto" label="投诉图片" prop="yonghutoushuPhoto">
                        <file-upload
                            tip="点击上传投诉图片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.yonghutoushuPhoto?ruleForm.yonghutoushuPhoto:''"
                            @change="yonghutoushuPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghutoushuPhoto" label="投诉图片" prop="yonghutoushuPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.yonghutoushuPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="投诉类型" prop="yonghutoushuTypes">
                        <el-select v-model="ruleForm.yonghutoushuTypes" :disabled="ro.yonghutoushuTypes" placeholder="请选择投诉类型">
                            <el-option
                                v-for="(item,index) in yonghutoushuTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="投诉类型" prop="yonghutoushuValue">
                        <el-input v-model="ruleForm.yonghutoushuValue"
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="投诉详情" prop="yonghutoushuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yonghutoushuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghutoushuContent" label="投诉详情" prop="yonghutoushuContent">
                            <span v-html="ruleForm.yonghutoushuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yonghutoushuName: false,
                    yonghutoushuPhoto: false,
                    yonghutoushuTypes: false,
                    yonghutoushuStatusTypes: false,
                    yonghuId: false,
                    shangjiaId: false,
                    yonghutoushuContent: false,
                },
                ruleForm: {
                    yonghutoushuName: '',
                    yonghutoushuPhoto: '',
                    yonghutoushuTypes: '',
                    yonghutoushuStatusTypes: '',
                    yonghuId: '',
                    shangjiaId: '',
                    yonghutoushuContent: '',
                },
                yonghutoushuTypesOptions : [],
                yonghutoushuStatusTypesOptions : [],
                shangjiaOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghutoushuName: [
                   ...
                   yonghutoushuPhoto: [
                              { required: true, message: '投诉图片不能为空', trigger: 'blur' },
                          ],
                   yonghutoushuTypes: [
                   ...
                   shangjiaId: [
                              { required: true, message: '投诉商家不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghutoushu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yonghutoushuTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghutoushu_status_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yonghutoushuStatusTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yonghutoushu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yonghutoushuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            yonghutoushuPhotoUploadChange(fileUrls){
                this.ruleForm.yonghutoushuPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
