...
var centerMenu = [
    ...
    ,{
        name: '商品收藏',
        url: '../kafeiCollection/list.html'
    }
    ,{
        name: '商品订单',
        url: '../kafeiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '用户投诉',
        url: './pages/yonghutoushu/list.html'
    },

]

var adminurl =  "http://localhost:8080/chuyikafeizaixianxiaoshou/admin/dist/index.html#/login";
