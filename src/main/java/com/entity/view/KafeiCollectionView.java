...
public class KafeiCollectionView extends KafeiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String kafeiCollectionValue;
	...
	public KafeiCollectionView() {

	}

	public KafeiCollectionView(KafeiCollectionEntity kafeiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, kafeiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getKafeiCollectionValue() {
				return kafeiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setKafeiCollectionValue(String kafeiCollectionValue) {
				this.kafeiCollectionValue = kafeiCollectionValue;
			}
