...
public class KafeiCommentbackView extends KafeiCommentbackEntity implements Serializable {
	...
	public KafeiCommentbackView() {

	}

	public KafeiCommentbackView(KafeiCommentbackEntity kafeiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, kafeiCommentbackEntity);
